...
export declare function computeMidpoint(
    rect: Rect
): {
    x: number;
    y: number;
};
export declare function removePaddingFromRect(
    element: HTMLElement,
    rect: Rect
): {
    x: number;
...
export declare function updateContainingStyleSize(
    containingElement: HTMLDivElement,
    direction: 'horizontal' | 'vertical',
    amount: number
): void;
export declare function calculatePlacement(
    rectA: Rect,
    rectB: Rect,
    direction: 'horizontal' | 'vertical'
): Placement;
export declare function growOrShrinkRectInList(
    rects: Array<Rect>,
    startIndex: number,
    offset: Position
): Rect[];
export declare function translateRectsBy(
    rects: Array<Rect>,
    startIndex: number,
    offset: Position
): Rect[];
export declare function moveRectTo(
    { width, height }: Rect,
    { x, y }: Position
): {
    x: number;
